...
<div class="boxinbox-inside" style="margin-top:10px;">
    ...
    <div style="display: flex; flex-direction: row; min-height: 100px; align-items: center;" class="boxinbox-inside__body">
        ...
        <div style="width: 45%;;display: flex; flex-direction: column;" class="boxinbox-inside__item">
            <span>Ważny do: 2023-08-14</span>
            <h3>Pozostało: 29 dni</h3>
        </div>
...
<div class="listing-actionbar justify-content-between flex-wrap" style="margin-top:10px;gap: 20px;">
    <span style="">Chcesz doładować konto? Zrobisz to przez - www.beautycheck.pl</span>
...
<div class="listing-actionbar flex-wrap bottom-buttons" style="gap:10px">
    <a href="/functions/usrimage.php"><button type="button" class="btn1" style=""><i class="fas fa-camera" aria-hidden="true"></i> Zmień zdjęcie</button></a>
    <a href="/functions/editaccount.php"><button type="button" class="btn1" style=""><i class="fas fa-edit" aria-hidden="true"></i> Edytuj dane</button></a>
    <a href="/functions/usrsignature.php"><button type="button" class="btn1" style=""><i class="fas fa-pen" aria-hidden="true"></i> Dodaj/edytuj podpis</button></a>
    <a href="/functions/usrpin.php"><button type="button" class="btn1" style=""><i class="fas fa-lock" aria-hidden="true"></i> Ustaw pin</button></a>
</div>
