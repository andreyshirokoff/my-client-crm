<div>
    ...
    @if($resultJson)
        <div id="heading_block3_2_aktualna_karta_klienta">
            <div class="boxinbox-titlebar">
                <div class="icon">
                    <i class="fas fa-id-card-alt" aria-hidden="true"></i>
                </div>
                <div style="margin-left:20px;"><h3>ResultJson</h3></div>
            </div>
            <div class="boxinbox" style="background-color: rgb(240, 241, 241);">
                <div class="listing-element service-block flex-nowrap gap-4">
                    <input type="text" class="form-control" wire:model="resultJson" id="jsonText">
                    <i class="fa-solid fa-copy" style="font-size: 25px" id="copyButton"></i>
                </div>
            </div>
        </div>
        <div class="mar"></div>
...
{{--                    <i class="fas fa-id-card-alt" aria-hidden="true"></i>--}}
{{--                </div>--}}
{{--                <div style="margin-left:20px;"><h3>Aktualna karta klienta</h3></div>--}}
{{--            </div>--}}
        ...
        <script>
            ...
            document.addEventListener("click", function(e) {
                if(e.target.id === 'copyButton')
                {
                    ...
                    alert("Skopiowano tekst: " + input.value);
                }
