...
{{--                    <a href="{{route('treatment.question', ['type' => 'karta', 'id_service' => $service->id])}}">123</a>--}}
                    <a href="{{route('treatment.question')}}?type=karta&idservice={{$service->id}}">@if(\App\Models\ServicesForm::where('service_id', $service->id)->first())<i class="fa-solid fa-pen-to-square"></i> @else Dodaj @endif</a>
                </div>
                <div style="width:20%">
