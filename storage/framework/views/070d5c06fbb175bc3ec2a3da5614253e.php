<div>
    <form
        action="<?php echo e(route('treatment.create.add')); ?>"
        method="POST"
    >
        <?php echo csrf_field(); ?>
        <style>
...
<?php /**PATH /var/www/di.251/data/www/my-client-crm.digitallab.com.ua/resources/views/livewire/settings/treatment-create-index.blade.php ENDPATH**/ ?>