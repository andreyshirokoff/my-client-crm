<form method="POST" action="<?php echo e(route('save.sign')); ?>" id="save-sign-form">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/di.251/data/www/my-client-crm.digitallab.com.ua/resources/views/livewire/usr-signature-index.blade.php ENDPATH**/ ?>