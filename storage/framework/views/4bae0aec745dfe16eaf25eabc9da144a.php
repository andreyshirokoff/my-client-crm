...
<div class="listing-element flex-wrap justify-content-between">
    ...
    <div style="display:flex;justify-content:center;flex-wrap: wrap;gap:15px" class="btns">
        <button type="button" onclick="location.href='<?php echo e(url('functions/document_kartaklienta_edit')); ?>?id=10408&amp;idkarty=10408&amp;id_dokumentu=10408';" class="btn1" style="color:white"><i class="fas fa-plus-circle" aria-hidden="true"></i> Edytuj</button>
        <button type="button" onclick="location.href='<?php echo e(url('functions/document_kartaklienta_delete')); ?>?id=10408'" class="btn1" style="color:white"><i class="fas fa-trash" aria-hidden="true"></i> Usuń</button>

    </div>
</div>
<div class="listing-ending"></div>
<?php /**PATH /var/www/di.251/data/www/my-client-crm.digitallab.com.ua/resources/views/blocks_content/block3_ogolna_karta_klienta.blade.php ENDPATH**/ ?>