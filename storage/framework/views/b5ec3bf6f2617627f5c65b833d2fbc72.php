...
<?php $__currentLoopData = $infoGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="listing-element" style="margin-top:10px;flex-direction:column;">
    <div style="display:flex;flex-direction:row;width:100%;" class="pac-body">
        ...
        <div style="width:15%">
            <h6><?php echo e($item->sms_count); ?></h6>
        </div>
        <div style="width:55%">
...
<?php /**PATH /var/www/di.251/data/www/my-client-crm.digitallab.com.ua/resources/views/livewire/history-index.blade.php ENDPATH**/ ?>