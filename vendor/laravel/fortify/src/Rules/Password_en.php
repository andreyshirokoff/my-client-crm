    ...
    public function message()
    {
        ...
        switch (true) {
            ...
            && ! $this->requireSpecialCharacter:
                return __('Pole :attribute musi składać się z co najmniej :length znaków i zawierać co najmniej jedną wielką literę.', [
                    'length' => $this->length,
                ]);
            ...
            && ! $this->requireSpecialCharacter:
                return __('Pole :attribute musi składać się z co najmniej :length znaków i zawierać co najmniej jedną cyfrę.', [
                    'length' => $this->length,
                ]);
            ...
            && ! $this->requireUppercase
            && ! $this->requireNumeric:
                return __('Pole :attribute musi składać się z co najmniej :length znaków i zawierać co najmniej jeden znak specjalny.', [
                    'length' => $this->length,
                ]);
            ...
            && $this->requireNumeric
            && ! $this->requireSpecialCharacter:
                return __('Pole :attribute musi składać się z co najmniej :length znaków i zawierać co najmniej jedną wielką literę i jedną cyfrę.', [
                    'length' => $this->length,
                ]);
            ...
            && $this->requireSpecialCharacter
            && ! $this->requireNumeric:
                return __('Pole :attribute musi mieć co najmniej :length znaków i zawierać co najmniej jedną wielką literę i jeden znak specjalny.', [
                    'length' => $this->length,
                ]);
            ...
            && $this->requireNumeric
            && $this->requireSpecialCharacter:
                return __('Pole :attribute musi składać się z co najmniej :length znaków i zawierać co najmniej jedną wielką literę, jedną cyfrę i jeden znak specjalny.', [
                    'length' => $this->length,
                ]);
            ...
            && $this->requireSpecialCharacter
            && ! $this->requireUppercase:
                return __('Pole :attribute musi składać się z co najmniej :length znaków i zawierać co najmniej jeden znak specjalny i jedną cyfrę.', [
                    'length' => $this->length,
                ]);

            default:
                return __('Pole :attribute musi składać się z co najmniej :length znaków.', [
                    'length' => $this->length,
                ]);
        }
    }
